...
<?$infoSection = CIBlockSection::GetList(array(),array("IBLOCK_ID" => $arParams["IBLOCK_ID"], "CODE" => $arResult["VARIABLES"]["SECTION_CODE"]))->GetNext();?>
<?$APPLICATION->SetTitle($infoSection["NAME"]);?>

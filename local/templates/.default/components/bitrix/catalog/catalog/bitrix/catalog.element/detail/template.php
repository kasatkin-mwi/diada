...
<div class="detail_top_big_block" id="<?=$itemIds['ID']?>">
    <div class="detail_top_big_left_col">
        <div class="detail_top_big_img_block" id="<?=$itemIds['BIG_SLIDER_ID']?>">
            ...
            ?>
                <?$alt_amg = str_replace('"', '\'', $arResult['NAME']); ?>
                <a style="cursor: pointer" class="fancybox_gal" rel="detail_small_img" href="<?=$arResult['DETAIL_PICTURE']['SRC']?>">
                    <img itemprop="image" src="<?=$detailResize?>" alt="<?=$alt_amg?>" title="<?=$alt_amg?>"/>
        ...
        <?if ((is_array($arProps['ADD_PHOTOS']['VALUE']) && count($arProps['ADD_PHOTOS']['VALUE'])) || $arProps['PHOTO_3D']['VALUE'] || $arProps['VIDEO_IFRAME']['VALUE']):?>
            <div class="detail_top_big_small_img_block">
                <div class="new_det_gall_bl" data-entity="images-container">
                    
                        <div class="detail_photo_produce_block">
                            <ul class="not_style detail_photo_gallery">
                                <?if ($arProps['ADD_PHOTOS']['VALUE']):?>
                                    ...
                                    <?php $ii++; ?>
                                        ...
                                        <li>
                                            ...
                                            <a class="detail_small_img_gray_el fancybox_gal" rel="detail_small_img" href="<?=$arPhoto['SRC']?>">
                                                <img src="<?=$arImg['src']?>"  alt="<?=$alt_amg?> <?=$ii?>" title="<?=$alt_amg?> <?=$ii?>"/>
                                            </a>
                                        </li>
                                    <?endforeach;?>
                                <?endif;?>
                    ...
                    <?if ($arProps['PHOTO_3D']['VALUE']):?>
                        <a class="detail_small_img_3d_el fancybox_3d" href="/3d_viewer/viewer.php?album_id=<?=$arProps['PHOTO_3D']['VALUE']?>"></a>
                    <?endif;?>
                    <?if ($arProps['VIDEO_IFRAME']['VALUE']):?>
                        <a class="detail_small_img_video_el" rel="detail_small_img" href="/img/detail_big_img.png"></a>
                    <?endif;?>
                </div>
            </div>
        <?endif;?>
                    ...
                    <form>
                        <label class="detail_complect_el set_base" data-type="base">
                            <span class="detail_complect_el_l detail_complect_el_price">
                                <span class="detail_complect_el_new_price" id="<?=$itemIds['PRICE_ID']?>">
                                    <?=$price['PRINT_RATIO_PRICE']?>
                                </span>
                                <?
                                if ( $arResult['PROPERTIES']['oldprice']['VALUE'] )
                                {
                                    ?>
                                    <span class="detail_complect_el_old_price" id="<?=$itemIds['OLD_PRICE_ID']?>">
                                        <?=$arResult['PROPERTIES']['oldprice']['VALUE']?>
                                    </span>
                                    <?
                                }
                                ?>
...
<?endif;*/?>
                ...
                <div class="det_filt_bl">
                                ...
                                if ($haveOffers && !empty($arResult['OFFERS_PROP']))
                                {
                                    ...
                                    <div id="<?=$itemIds['TREE_ID']?>">
                                        ...
                                        foreach ($arResult['SKU_PROPS'] as $skuProperty)
                                        {
                                            ...
                                            {
                                                ?>
                                                <div class="det_color_bl" data-entity="sku-line-block">
                                                    <div class="det_color_tit"><?=htmlspecialcharsEx($skuProperty['NAME'])?>:  <span>Название цвета</span></div>
                                                    <div class="det_color_list">
                                                        <ul>
                                                        <?
                                                        foreach ($skuProperty['VALUES'] as &$value)
                                                        {
                                                            ...
                                                            if ($skuProperty['SHOW_MODE'] === 'PICT')
                                                            {
                                                                ...
                                                                <li data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>">
                                                                    <a href="javascript:void(0);"><img src="<?=$value['PICT']['SRC']?>"/></a>
                                                                </li>
                                                                <?    
                                                            }
                                                        }
                                            ...
                                            {
                                                ?>
                                                <div class="det_size_bl" data-entity="sku-line-block">
                                                    <div class="det_size_tit"><?=htmlspecialcharsEx($skuProperty['NAME'])?>:</div>
                                                    <div class="det_size_select">
                                                        <a class="det_size_sel_bt" href="javascript:void(0);">Выберите из списка<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                        <ul class="det_size_sel_list not_style">
                                                            <?
                                                            foreach ($skuProperty['VALUES'] as &$value)
                                                            {
                                                                $value['NAME'] = htmlspecialcharsbx($value['NAME']);
                    ...
                    <?/*<div class="det_color_bl">
                        <div class="det_color_tit">Цвет:  <span>Название цвета</span></div>
                        <div class="det_color_list">
                            <a href=""><img src="/img/det_color_ic1.png"/></a>
                            <a href=""><img src="/img/det_color_ic2.png"/></a>
                            <a href=""><img src="/img/det_color_ic3.png"/></a>
                        </div>
                    </div>
                    <div class="det_size_bl">
                        <div class="det_size_tit">Размер:</div>
                        <div class="det_size_select">
                            <a class="det_size_sel_bt open" href="">Выберите из списка<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <ul class="det_size_sel_list not_style" style="display:block;">
                                <li><a href="">44-46/170-176</a></li>
                                <li><a class="active" href="">48-50/170-176</a></li>
                                <li><a href="">48-50/182-188</a></li>
                                <li><a href="">52-54/170-176</a></li>
                                <li><a href="">52-54/182-188</a></li>
                                <li><a href="">56-58/170-176</a></li>
                                <li><a href="">56-58/182-188</a></li>
                                <li><a href="">60-62/182-188</a></li>
                            </ul>
                        </div>
                    </div>*/?>
                </div>
                <div class="det_status_kol_bl">
                    <div class="det_status_kol_l">
                        <?
						$arProps['INDIKATOR']['VALUE_XML_ID'];
					...
					<?if ( $indikator !== 'net' ):?>
						<div class="det_status_kol_r">                
							<div class="buy_number">
								<a class="js_number_prev" href="javascript:void(0);" id="<?=$itemIds['QUANTITY_DOWN_ID']?>"><img src="/img/number_prev.png" alt=""></a>
								<input class="number" type="number" id="<?=$itemIds['QUANTITY_ID']?>" value="<?=$price['MIN_QUANTITY']?>">
								<a class="js_number_next" href="javascript:void(0);" id="<?=$itemIds['QUANTITY_UP_ID']?>"><img src="/img/number_next.png" alt=""></a>
							</div>
						</div>
					<?endif;?>
                </div>
				<?if ( $indikator !== 'net' ):?>
					<div class="new_det_buy_bl">
						<?/* <a id="button_buy_product" class="new_det_buy_bt" data-id="<?=$actualItem['ID']?>" href="" itemscope itemtype="http://schema.org/BuyAction"><span>Купить</span></a> */?>
						<a id="button_buy_product" class="new_det_buy_bt" data-id="<?=$actualItem['ID']?>" href="" itemscope itemtype="http://schema.org/BuyAction"><span>Купить</span></a>
					</div>
				<?endif;?>
                <?/* <div class="new_det_doubl_bt">
                    <a class="new_det_gray_bt green_h fancy_ajax_click_buy" data-entity="by-one-click" href="/include/popup_oneclick.php?PRODUCT_ID=<?=$arResult['ID']?>"><i class="det_basket"></i>В 1 клик</a>
                    <a class="new_det_gray_bt blue_h fancy_ajax_click_buy" data-entity="by-credit" href="/include/popup_credit.php?PRODUCT_ID=<?=$arResult['ID']?>"><i class="det_credit">%</i>В кредит</a>
                </div> */?>
                ...
                <div class="det_favor_srav_bl">
                    <a class="det_srav_bt js_det_srav_bt" data-entity="to-compare" href="<?=$arResult['COMPARE_URL']?>">В сравнение</a>
                    <a class="det_favor_bt js_det_favor_bt" data-entity="to-favourite" data-id="<?=$arResult['ID']?>" href="">В избранное</a>
                </div>
				...
				if ($USER->IsAdmin()):?>
					<br>
					<a href="https://www.air-gun.ru/search?find=DD<?=$arResult['ID']?>" target="_blank" class="">
						<span>На AIR-GUN</span>
					</a>
					
					<br><br>
					<p>Склад Автозаводcкая - <?=$arResult['CATALOG_QUANTITY']?> шт.</p>
...
if ($haveOffers)
{
    ...
    foreach($arResult['OFFERS'] as $offer)
    {
        $offersSet[$offer['ID']] = $offer;    
    }
    ?>
    <script>
        offersSet = <?=CUtil::PhpToJSObject($offersSet, false, true)?>
    </script>
    <?
   // echo '<pre>'; echo '<br>'; var_export($offersSet); echo '</pre>';     
}
?>
<script>
    BX.message({
...
{
    if(!BX.type.isArray(offersSet))
    {
        if($('#button_buy_product').length)
        {
            console.log(offersSet);
            var offerId = $('#button_buy_product').attr('data-id');
            console.log(offerId);
            var baseArr = offersSet[offerId]['PROPERTIES']['SET_BASE']['VALUE'];
            var masterArr = offersSet[offerId]['PROPERTIES']['SET_MASTER']['VALUE'];
            var profiArr = offersSet[offerId]['PROPERTIES']['SET_PROFI']['VALUE'];

            var arBase = [offerId, (!!baseArr ? baseArr.join(',') : '' )];
            var arMaster = [offerId, (!!masterArr ? masterArr.join(',') : '' )];
            var arProfi = [offerId, (!!profiArr ? profiArr.join(',') : '' )];
            
            var baseDiscount = !!offersSet[offerId]['PROPERTIES']['SET_BASE_DISCOUNT']['VALUE'] ? parseInt(offersSet[offerId]['PROPERTIES']['SET_BASE_DISCOUNT']['VALUE']) : 0;
            var masterDiscount = !!offersSet[offerId]['PROPERTIES']['SET_MASTER_DISCOUNT']['VALUE'] ? parseInt(offersSet[offerId]['PROPERTIES']['SET_MASTER_DISCOUNT']['VALUE']) : 0;
            var profiDiscount = !!offersSet[offerId]['PROPERTIES']['SET_PROFI_DISCOUNT']['VALUE'] ? parseInt(offersSet[offerId]['PROPERTIES']['SET_PROFI_DISCOUNT']['VALUE']) : 0;
            var arSets = arBase.concat(arMaster, arProfi);
            var unsetProduct = offerId;
            var iblockId = 37;     
        }
    }
    else
    ...
    $.getJSON('<?=$templateFolder?>/get_set.php', {sets:arSets,unsetProduct:unsetProduct,iblockId:iblockId}, function(data) {
        ...
        console.log(number_format(priceBase-baseDiscount, 0, '', ' '));
        console.log(priceMaster);
        console.log(priceProfi);

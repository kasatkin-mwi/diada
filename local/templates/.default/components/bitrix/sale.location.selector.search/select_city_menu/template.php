...
<?else:?>
	...
	<div class="find_city mobile_find_city">
		<div class="input_wrap">
            ...
            <ul class="mobile_find_city_list">
                <?foreach ($arResult["TOWNS_LIST"] as $idSity=>$nameSity):?>
                    <li><a href="#" data-city-id="<?=$idSity?>"><?=$nameSity?></a></li>
                <?endforeach;?>
            </ul>
		</div>
	</div>

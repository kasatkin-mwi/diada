...
<?
        ...
        <table width="95%">
            ...
            <tr>
                ...
                <?endforeach?>
                    ...
                    <a style="margin-top: 20px" class="red_button" href="javascript:void(0);" onclick="$(this).siblings('input[type=submit]').click();"><span>Выйти</span></a>
                </td>
            </tr>
        </table>
    </form>
    ...
    <?if(!$USER->IsAuthorized()):?>
        ...
        <p class="all_social_sale">СКИДКИ</p>
        <p class="all_social_reg">при регистрации</p>
        <a class="red_button" href="/auth/reg/"><span>Регистрация</span></a>
    <?endif?>
</div>
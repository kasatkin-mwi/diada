...
if(strlen($arResult["OK_MESSAGE"]) > 0)
{
	?><div class="error_page_nothelp_txt js_error_page_nothelp_txt">
		 По делом Арчи! ) Пусть оттачивает поисковые навыки! Воспользуйтесь строкой "Умного поиска" или позвоните нам по бесплатному номеру <a href="tel:88003330742">8-800-333-07-42</a> <br>
...
<?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("MESSAGE", $arParams["REQUIRED_FIELDS"])):?><?endif?>
 ...
 <input class="error_page_gray_bt js_error_page_gray_bt" type="submit" name="submit" value="<?=GetMessage("MFT_SUBMIT")?>">

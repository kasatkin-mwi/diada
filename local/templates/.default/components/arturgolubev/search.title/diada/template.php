...
<div id="<?echo $CONTAINER_ID?>" class="bx-searchtitle  <?=$arResult["VISUAL_PARAMS"]["THEME_CLASS"]?>">
	<form action="<?echo $arResult["FORM_ACTION"]?>">
		<div class="bx-input-group red_search_form js_red_search_form">
			<input placeholder="Умный поиск по сайту" id="<?echo $INPUT_ID?>" placeholder="<?=$arParams["INPUT_PLACEHOLDER"]?>" type="text" name="q" value="<?=htmlspecialcharsbx($_REQUEST["q"])?>" autocomplete="off" class="bx-form-control"/>

...
$APPLICATION->IncludeComponent("arturgolubev:search.title", "diada", Array(
								...
								"PREVIEW_HEIGHT_NEW" => "70",	// Высота картинки
								"PREVIEW_TRUNCATE_LEN" => "",	// Максимальная длина анонса для вывода
								"PREVIEW_WIDTH_NEW" => "70",	// Ширина картинки
								"PRICE_CODE" => array(	// Тип цены
									0 => "base",
								),
								"PRICE_VAT_INCLUDE" => "Y",	// Включать НДС в цену
								"SHOW_INPUT" => "Y",	// Показывать форму ввода поискового запроса
								"SHOW_LOADING_ANIMATE" => "N",	// Показывать анимацию загрузки
								...
								"TOP_COUNT_ITOG" => "8",
								"TOP_COUNT" => "160",	// Количество результатов в категории

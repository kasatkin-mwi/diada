...
<?else:?>
    ...
    <?=bitrix_sessid_post()?>
        ...
        <div class="one_click_form_title">Купить в кредит</div>
        ...
        <div class="one_click_form_el">
            <input type="text" name="user_phone" id="one_click_user_phone" class="required<?if(in_array('PHONE',$arResult['ERROR_MESSAGE'])):?> sal_error<?endif?>" style="font-size: 20px;" placeholder="Телефон" value="<?=$arResult["PHONE"]?>"/>
            <script>
                maskAktive("",true,"#one_click_user_phone");
            </script>
        </div>

...
//$MESS["DELIVERY_CHANGE_WARNING"] = "Стоимость доставки может отличаться в зависимости от габаритов и веса груза, она будет рассчитана менеджером при подтверждении заказа.";

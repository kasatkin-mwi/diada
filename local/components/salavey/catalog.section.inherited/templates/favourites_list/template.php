		...
		<div class="cat_tb_el_r">
			...
			<?if ( $arItem['CATALOG_AVAILABLE'] !== 'N' ):?>	
				<div id="buy_element_<?=$arItem['ID']?>" class="cat_tb_buy">
					<a itemscope itemtype="http://schema.org/BuyAction"  class="buy_element_button newcat_buy fancy_pay_war" data-name="<?=$arItem['NAME']?>" data-id="<?=$arItem['ID']?>" href="<?=$arItem['ADD_URL']?>">Купить</a>
				</div>
			<?endif;?>
		</div>
	</div>

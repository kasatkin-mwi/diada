...
_this.RESULT.style.width=(window.innerWidth)+"px";var fade;if(tbl)fade=BX.findChild(_this.RESULT,{'class':'title-search-fader'},!0);if(fade&&th)
{res_pos=BX.pos(_this.RESULT);fade.style.left=(res_pos.right-res_pos.left-18)+'px';fade.style.top=0+'px';fade.style.height=(res_pos.bottom-res_pos.top)+'px';fade.style.display='block'}};this.onKeyPress=function(keyCode)
...
{_this.RESULT.style.position='fixed';_this.RESULT.style.zIndex=BX.style(fixedParent,'z-index')+2;pos=BX.pos(_this.CONTAINER,!0)}

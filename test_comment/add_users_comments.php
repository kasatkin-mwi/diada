...
$fileResponseProduct = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/test_comment/about_product.xml");
$fileResponseSite = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/test_comment/about_site.xml");
...
$resProductDiada = CIBlockElement::GetList(
    array("ID" => "ASC"),
    array("IBLOCK_ID" => 1, "INCLUDE_SUBSECTIONS" => "Y", "ACTIVE" => "Y"),
    false,

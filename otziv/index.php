 ...
 <a class="red_arrow_comment js_type_comment" href=""><?=$arSort[$sort]?></a>
				<ul class="js_type_comment_light type_comment_light">
					...
					<li><a class="<?=$k?> <?if ($sort == $k) echo 'active'?>
					 " href="<?=$APPLICATION->
					 GetCurPageParam('sort='.$k, array('sort'))?>" title="<?=$v?>"><span class="bxhtmled-surrogate-inner"><span class="bxhtmled-right-side-item-icon"></span><span class="bxhtmled-comp-lable" unselectable="on" spellcheck="false"></span></span><?=$v?></a></li>
					 <?endforeach;?>
				</ul>
			</div>
			 отзывы

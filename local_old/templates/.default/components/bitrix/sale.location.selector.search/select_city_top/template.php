...
<?else:?>
	...
	<div class="find_city">
		...
		<p class="descr">
			...
			<br />
			От выбора зависит способ получения заказа.
		</p>
		<div class="input_wrap">
			...
			<p>
				Например, <a href="#" data-city-id="84">Москва</a> <a href="#" data-city-id="85">Санкт-Петербург</a>
			</p>
		</div>
		<div class="left">
			<span>Не нашли город?</span>
			<a href="/delivery/?city=25128">Доставка по России</a>
		</div>
		<p class="descr_b">Доставляем по всей России. Оплата наложенным платежом (наличными при получении), банковскими картими, электронными деньгами</p>
	</div>

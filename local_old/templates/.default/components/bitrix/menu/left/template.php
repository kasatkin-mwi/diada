...
<ul class="catalog_menu_light" itemprop="about" itemscope itemtype="http://schema.org/ItemList">
...
$hideChildre = false; 
    foreach($arResult["DESCTOP_ITEMS"] as $arItem):?>
        ...
        <?if ($arItem["IS_PARENT"] && ($arItem["DEPTH_LEVEL"] == 1)):?>
            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ItemList" class="<?if ($iCounter >= 12):?>hide_section<?endif;?>"><a itemprop="url" href="<?=$arItem["LINK"]?>">

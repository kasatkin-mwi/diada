...
if (isset($arResult['ITEM']))
{
    ...
    if ($item['~PREVIEW_PICTURE']>0) {
        $resizeImg = CFile::ResizeImageGet($item['~PREVIEW_PICTURE'], array("width" => 250, "height" => 90))["src"];
    }
    elseif ($item['~DETAIL_PICTURE']>0){
        $resizeImg = CFile::ResizeImageGet($item['~DETAIL_PICTURE'], array("width" => 250, "height" => 90))["src"];
    }

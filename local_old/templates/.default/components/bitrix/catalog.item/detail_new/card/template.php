...
<li>
    ...
    <div class="big_data_el_bl">
		<div class="big_data_el">
			<div class="detail_right_produce_right_col_title">
				<a href="<?=$item['DETAIL_PAGE_URL']?>"><?=mb_strimwidth ($item['NAME'], 0, 100)?></a>
			</div>
			<div class="big_data_el_cont">
				...
				<?endif;*/?>
			<div class="big_data_el_bot">
				<div class="big_data_el_stat">
				...
				<?if ( $indikator !== 'net' ):?>
					<a class="red_buy fancy_pay_war" data-id="<?=$item['ID']?>" href="<?=$item['ADD_URL']?>">Купить</a>
				<?endif;?>
			</div>
		</div>
    </div>

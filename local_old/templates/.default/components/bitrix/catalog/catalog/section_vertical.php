        ...
        <?if (true):?>
		    <div class="sortirovka_block">
                ...
                <ul class="vid_tovara not_style display_none_m display_none_mp">
                    <li>Показывать:</li>
                    <li><a class="table_vid_tovara js_table_vid_tovara <?if ($view=='table') echo 'active_table_vid_tovara'?>" href="<?=$APPLICATION->GetCurPageParam('view=table', Array('view'))?>">таблицей</a></li>
                    <li><a class="list_vid_tovara js_list_vid_tovara <?if ($view=='list') echo 'active_list_vid_tovara'?>" href="<?=$APPLICATION->GetCurPageParam('view=list', Array('view'))?>">списком</a></li>
                </ul>
                <div class="clear"></div>
            </div>
            <?
        ...
        <?else:?>
            <div class="sortirovka_block">
                <ul class="sortirovka not_style">
                    <li>Сортировать по:</li>
                    <?
                    $arSort = Array("price"=>"цене", "show_counter"=>"популярности", "name"=>"названию");
                    foreach($arSort as $code=>$name):
                        $class = "";
                        $orderUrl = "asc";

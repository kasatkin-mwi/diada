...
if (!$dontShowAll){
    ...
    {
        $arStoresList = array();
        $obStores = CCatalogStore::GetList(
            array('ID' => 'ASC'),
        ...
        while($arStores = $obStores->Fetch())
        {
            $arStoresList[] = $arStores["ID"];   
        }
    ?>
    ...
    <div class="content">
        <div class="center_column">
            <div class="section detail_section">
                ...
                <div class="box detail_box b3"<?=empty($arElement['DETAIL_TEXT']) && !$arProps['DOCS_PDF']['VALUE'] && !$showPropSection ? ' style="display:block;"' : ''?>>
                    ...
                    <div class="js_mobile_text_el_light">
                        ...
                        <div class="block_reviews" style="margin-bottom: 10px;"><span class="sp-stars-off"><span class="sp-stars-on" style="width: <?=$setReitingCSS?>%;"></span></span> <div style="display: inline-block;margin-left: 10px; position: relative;top: -7px;"><span style="padding: 2px 5px;background: rgba(255, 174, 0, 0.26); font-weight: bold"><?=number_format($setReiting,1);?></span> На основании <?=$iCounterReviews?> оценок</div></div>
                ...
                <div class="box detail_box b6" id="dostavka_region_block">
            ...
            <?if ($arProps['POHOG']['VALUE']):?>
                ...
                <?else:?>
                <!-- ***ТЕСТ*** -->
                <!-- компонет лежит: /testdiada.webtm.ru/public_html/bitrix/components/salavey/catalog.section.inherited/templates/detail_pohogie_new -->
                    <div class="">
                ...
                <?if(!$USER->IsAdmin()):?>
                    <div class="video" style="text-align: center;">
                        <?foreach($arProps['VIDEO_IFRAME']['~VALUE'] as $video):?>
                            <?=str_replace(array("https://www.youtube.com/v/","<iframe"),array("https://www.youtube.com/embed/", "<iframe style='margin: 0 auto;'"),$video)?>
                        <?endforeach;?>
                    </div>
                <?else:?>
                    <!-- ***ТЕСТ*** -->
            ...
            <?else:?>
                <!-- ***ТЕСТ*** -->
                <!-- компонент лежит: /testdiada.webtm.ru/public_html/bitrix/templates/.default/components/bitrix/catalog.section/detail_prosmotrennye_new -->
                    <div class="display_none_m display_none_mp">
        ...
        <?else:?>
            <!-- ***ТЕСТ*** -->
            <!-- компонент лежит: /testdiada.webtm.ru/public_html/bitrix/components/salavey/catalog.section.inherited/templates/big_data_detail_new -->
                <div class="right_column display_none_m dispay_none_mp">
                    <div class="display_none_m display_none_mp">
                        <div class="h2 detail_right_produce_h2">Рекомендуем</div>
                        <div class="detail_right_produce_slider_block carousel_slider_brend_block">

			...
			<div class="basket_page_left_col" id="basket_items">
                ...
                <div class="bx_ordercart_order_pay_left" id="coupons_block">
                    ...
                    if ($arParams["HIDE_COUPON"] != "Y")
                    {
                        ...
                        <span style="color: black"><?=GetMessage("STB_COUPON_PROMT")?></span><input type="text" id="coupon" name="COUPON" value="" onchange="enterCoupon();">&nbsp;<a style="min-width: auto" class="bx_bt_button red_button" href="javascript:void(0)" onclick="enterCoupon();" title="<?=GetMessage('SALE_COUPON_APPLY_TITLE'); ?>"><?=GetMessage('SALE_COUPON_APPLY'); ?></a>
                        </div><?

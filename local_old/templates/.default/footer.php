        ...
        <footer>
            <div class="foot_bl standart_width">
                ...
                <a style="display: none; width: 100%;" href="?mobile" class="foot_versiya_site" id="mob" onclick="setCookie('mob', 'yes', 86400, '/');">Мобильная версия сайта</a>
                <? }else{ ?>
                <a style="display: none; width: 100%;" href="?mobile=no" class="foot_versiya_site" id="mob" onclick="setCookie('mob', 'no', 86400, '/');">Полная версия сайта</a>
                <? } ?>
        ...
        <?/*<footer>
            ...
            <script>$("img[src='/upload/resize_cache/iblock/fbc/910_400_1/bannerdiada-.png']").addClass("demisale-campaign-banner");</script>
            <script>$("img[src='/upload/resize_cache/iblock/fbc/910_400_1/bannerdiada-.png']").parent().removeAttr("href");</script>

        </footer>*/?>
        <div id="back_top" style="display: block;"><span></span></div>
        
        <?if ($GLOBALS["USER"]->IsAdmin()):?>
            <?include_once($_SERVER['DOCUMENT_ROOT'].'/include/salavey_callback.php');?>
        <?endif;?>
    </div>
...
<iframe src='/title.php' style="display:none;"></iframe>
</body>
</html>